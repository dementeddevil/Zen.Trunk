...
namespace Zen.Trunk.TaskSchedulers
{
    ...
    public sealed class IOCompletionPortTaskScheduler : TaskScheduler, IDisposable
    {
        ...
        protected override IEnumerable<Task> GetScheduledTasks() { return _tasks.ToArray(); }
        ...
        protected override bool TryExecuteTaskInline(Task task, bool taskWasPreviouslyQueued)
        {
            ...
            return _schedulerThread.Value && TryExecuteTask(task);
        }
        ...
        private sealed class IOCompletionPort : IDisposable
        {
            ...
            public bool WaitOne()
            {
                ...
                if (!GetQueuedCompletionStatus(_handle.DangerousGetHandle(), out lpNumberOfBytes, out lpCompletionKey, out lpOverlapped, INFINITE_TIMEOUT))
                {
