...
namespace Zen.Trunk.Storage.Locking
{
    public interface IGlobalLockManager
    {
        ...
        void LockDistributionExtent(DatabaseId dbId, VirtualPageId virtualPageId, uint extentIndex, ObjectLockType distLockType, DataLockType extentLockType, TimeSpan timeout);
